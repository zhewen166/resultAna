...
public class Main {
    public static void main(String args[]) throws IOException, WriteException {
        ...
        String appid = "app-20170329044946-0059";

        JxlUtil ju1 = new JxlUtil();
       ju1.setPath("/home/cz/Hadoop2/spark-all/resultAna/data/kmeans/zongxiang/Job.xls");

        JxlUtil ju2 = new JxlUtil();
        ju2.setPath("/home/cz/Hadoop2/spark-all/resultAna/data/kmeans/zongxiang/Stage.xls");

        JxlUtil ju3 = new JxlUtil();
        ju3.setPath("/home/cz/Hadoop2/spark-all/resultAna/data/kmeans/zongxiang/Task.xls");

        JxlUtil ju4 = new JxlUtil();
        ju4.setPath("/home/cz/Hadoop2/spark-all/resultAna/data/kmeans/zongxiang/JobNotStage.xls");
